 ...
 * syscalls. The kernel exposes its own calls through the "partos" service, and a
...
/*
 * Internal RST 0x10 syscall bridge around svc_query():
 * HL = name -> DE = function table.
 */
void __svc_query_rst10(void);
