...
install -m 755 packaging/linux/partner "$install_root/bin/partner"
install -m 755 packaging/linux/partnerg "$install_root/bin/partnerg"
ln -s /opt/iskra-delta-partner/bin/partner "$package_root/usr/bin/partner"
...
cp packaging/linux/partner.desktop "$package_root/usr/share/applications/"
...
test -x "$install_root/bin/partner"
...
grep -Fqx 'Exec=/usr/bin/partner' \
    "$package_root/usr/share/applications/partner.desktop"
